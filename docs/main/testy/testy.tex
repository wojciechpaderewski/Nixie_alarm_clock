...
By sprawdzić tą hipotezę, zmierzono wypełnienie sygnału sterującego dla napięć wyjściowych 130V, 210V.
Pomiary zamieszczono na \ref{fig:duty_130} i \ref{fig:duty_210}.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{duty_130.png}
    \caption{Wypełnienie sygnału sterującego przy napieciu wyjściowym 130V}
    \label{fig:duty_130}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Wypełnienie sygnału sterującego przy napieciu wyjściowym 210V}
    \label{fig:duty_210}
\end{figure}

Jak widać na \ref{fig:duty_210}, przy wysokim wypełnieniu sygnału sterującego,
...
Na wykresie \ref{fig:power} pobór mocy okazał się nie liniowy przy wyższych napięciach wyjściowych. Wynika to ze spadku wydajności przetwornicy przy wyższych napięciach,
z powodu nie zamykania się tranzystora przełączającego. Jednak układ domyślnie ma procować na niższych napięcia, więc 
zdecydowano się na programowe ograniczenie napięcia wyjściowego przetwornicy do 190V, gdzie charakterystyka poboru mocy jest jeszcze liniowa. Dolny limit napięcia wyjściowego również
