...
\begin{itemize}
  ...
  wysyła okresowo pakiet zawierający aktualne opóźnienie w odniesieniu do czasu UTC, na podstawie których klient kalibruje swoje zegary.
  ...
  \item GPS -  wykorzystuje odbiorniki GPS do synchronizacji zegarów na różnych serwerach.
   Zapewnia bardzo dokładne dane czasu. Czas ten można wykorzystać do synchronizacji
...
\begin{itemize}
  ...
  Protokół istnieje już bardzo długo, więc dobrze znany i istnieje wiele rozwiązań ułatwiających implementacje.
...
Aby nie powodować nadmiernego skomplikowania systemu i związanych z tym opóźnień, ilość warstw została ograniczona do 16(STRATUM 0 - STRATUM 15).
